const projects = [
...

    {
        ...
        github: `<a href="https://github.com/katiejduane/Sift" target="blank">GitHub</a>`,
        liveSite: `<a href="https://sift.katiejduane.com/" target="blank">Live Site</a>`,
        description: `<p class="description">Sift was made with curious explorers in mind. It allows users to organize and track all the things they want to experience; whether it's a hike, a new coffee shop, or a pottery class, they can add it, favorite it, and review it with Sift.</p>`,
        contributions: `<p>Contributions: Logo Design, Database Schema and Set-up, Responsive Design, Creation of re-usable React Components for each category, Initialized database connection, CSS debugging, Front End and Back End code for "To-Do" list and "Active" sections, Edit Logic, UI/UX overhaul, Debugging, Mobile Responsiveness, Middleware creation for User Id, Higher order component implementation.</p>`,
    },

    {
        ...
        liveSite: `<a href="https://emoceans.katiejduane.com/" target="blank">Live Site</a>`,
        description: `<p class="description">emOceans is a web application that allows you to take note of your mood every day using color and language. By providing an easy-to-use color palette and a word-finding API, we hoped to make the observation and appreciation of shifts in mood more accessible, helpful, and more beautiful.</p>`,
        contributions: `<p>Contributions: Concept, implementation of chroma.js for color manipulation, implementation of datamuse API, router management, registration connection, database schema, database connection, data visualization.</p>`,
    },
